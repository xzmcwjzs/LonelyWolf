...
{
    public class Chronic_disease_BloodGlucoseMap : EntityTypeConfiguration<Chronic_disease_BloodGlucose>
    {
        public Chronic_disease_BloodGlucoseMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_BloodGlucose");
