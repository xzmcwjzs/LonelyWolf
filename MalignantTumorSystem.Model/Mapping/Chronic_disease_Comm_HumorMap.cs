...
{
    public class Chronic_disease_Comm_HumorMap : EntityTypeConfiguration<Chronic_disease_Comm_Humor>
    {
        public Chronic_disease_Comm_HumorMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Humor");
