...
{
    public class Chronic_disease_Comm_LungAddMap : EntityTypeConfiguration<Chronic_disease_Comm_LungAdd>
    {
        public Chronic_disease_Comm_LungAddMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_LungAdd");
