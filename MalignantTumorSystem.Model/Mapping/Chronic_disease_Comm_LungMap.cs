...
{
    public class Chronic_disease_Comm_LungMap : EntityTypeConfiguration<Chronic_disease_Comm_Lung>
    {
        public Chronic_disease_Comm_LungMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.Property(t => t.result11)
                .HasMaxLength(50);

            this.Property(t => t.result22)
                .HasMaxLength(50);

            this.Property(t => t.result33)
                .HasMaxLength(50);
            ...
            this.ToTable("Chronic_disease_Comm_Lung");
            ...
            this.Property(t => t.result11).HasColumnName("result11");
            this.Property(t => t.result22).HasColumnName("result22");
            this.Property(t => t.result33).HasColumnName("result33");
