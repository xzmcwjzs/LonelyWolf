...
{
    public class Chronic_disease_Comm_Testing_BMCAddMap :EntityTypeConfiguration<Chronic_disease_Comm_Testing_BMCAdd>
    {
        public Chronic_disease_Comm_Testing_BMCAddMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_BMCAdd");
