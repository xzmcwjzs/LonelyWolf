...
{
    public class Chronic_disease_Comm_Testing_BMCMap : EntityTypeConfiguration<Chronic_disease_Comm_Testing_BMC>
    {
        public Chronic_disease_Comm_Testing_BMCMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.Property(t => t.check_company)
                .HasMaxLength(50);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_BMC");
            ...
            this.Property(t => t.check_company).HasColumnName("check_company");
