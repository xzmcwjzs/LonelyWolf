...
{
    public class Chronic_disease_Comm_Testing_Blood_AddMap : EntityTypeConfiguration<Chronic_disease_Comm_Testing_Blood_Add>
    {
        public Chronic_disease_Comm_Testing_Blood_AddMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_Blood_Add");
