...
{
    public class Chronic_disease_Comm_Testing_CSFAddMap : EntityTypeConfiguration<Chronic_disease_Comm_Testing_CSFAdd>
    {
        public Chronic_disease_Comm_Testing_CSFAddMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_CSFAdd");
