...
{
    public class Chronic_disease_Comm_Testing_CSFMap : EntityTypeConfiguration<Chronic_disease_Comm_Testing_CSF>
    {
        public Chronic_disease_Comm_Testing_CSFMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_CSF");
