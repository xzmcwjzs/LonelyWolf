...
{
    public class Chronic_disease_Comm_Testing_GeneDetectionMap :EntityTypeConfiguration<Chronic_disease_Comm_Testing_GeneDetection>
    {
        public Chronic_disease_Comm_Testing_GeneDetectionMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_GeneDetection");
