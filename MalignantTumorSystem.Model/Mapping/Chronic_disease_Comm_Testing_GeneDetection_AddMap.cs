...
{
    public class Chronic_disease_Comm_Testing_GeneDetection_AddMap :EntityTypeConfiguration<Chronic_disease_Comm_Testing_GeneDetection_Add>
    {
        public Chronic_disease_Comm_Testing_GeneDetection_AddMap()
        {
            // Primary Key
            this.HasKey(t =>t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_GeneDetection_Add");
            this.Property(t => t.id).HasColumnName("id");
            this.Property(t => t.blood_id).HasColumnName("blood_id");
