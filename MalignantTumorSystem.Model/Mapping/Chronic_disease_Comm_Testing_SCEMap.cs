...
{
    public class Chronic_disease_Comm_Testing_SCEMap : EntityTypeConfiguration<Chronic_disease_Comm_Testing_SCE>
    {
        public Chronic_disease_Comm_Testing_SCEMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_SCE");
