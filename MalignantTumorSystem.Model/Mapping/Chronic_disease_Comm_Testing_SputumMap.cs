...
{
    public class Chronic_disease_Comm_Testing_SputumMap :EntityTypeConfiguration<Chronic_disease_Comm_Testing_Sputum>
    {
        public Chronic_disease_Comm_Testing_SputumMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_Sputum");
