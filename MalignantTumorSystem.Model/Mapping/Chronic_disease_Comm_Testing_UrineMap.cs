...
{
    public class Chronic_disease_Comm_Testing_UrineMap : EntityTypeConfiguration<Chronic_disease_Comm_Testing_Urine>
    {
        public Chronic_disease_Comm_Testing_UrineMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Comm_Testing_Urine");
