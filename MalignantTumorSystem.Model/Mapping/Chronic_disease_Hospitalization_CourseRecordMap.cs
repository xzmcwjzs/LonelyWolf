...
{
    public class Chronic_disease_Hospitalization_CourseRecordMap :EntityTypeConfiguration<Chronic_disease_Hospitalization_CourseRecord>
    {
        public Chronic_disease_Hospitalization_CourseRecordMap()
        {
            // Primary Key
            this.HasKey(t =>t.id);
            ...
            this.ToTable("Chronic_disease_Hospitalization_CourseRecord");
