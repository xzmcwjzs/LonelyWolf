...
{
    public class Chronic_disease_OutpatientMap : EntityTypeConfiguration<Chronic_disease_Outpatient>
    {
        public Chronic_disease_OutpatientMap()
        {
            // Primary Key
            this.HasKey(t =>t.id);
            ...
            this.Property(t => t.outpatient_id)
                .HasMaxLength(50);
            ...
            this.ToTable("Chronic_disease_Outpatient");
            ...
            this.Property(t => t.outpatient_date).HasColumnName("outpatient_date");
            this.Property(t => t.outpatient_id).HasColumnName("outpatient_id");
            ...
            this.Property(t => t.finish_time).HasColumnName("finish_time");
