...
{
    public class Chronic_disease_Supplementary_Examination_MRIMap :EntityTypeConfiguration<Chronic_disease_Supplementary_Examination_MRI>
    {
        public Chronic_disease_Supplementary_Examination_MRIMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Supplementary_Examination_MRI");
