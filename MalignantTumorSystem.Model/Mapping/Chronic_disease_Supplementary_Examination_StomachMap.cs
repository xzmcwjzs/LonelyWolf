...
{
    public class Chronic_disease_Supplementary_Examination_StomachMap :EntityTypeConfiguration<Chronic_disease_Supplementary_Examination_Stomach>
    {
        public Chronic_disease_Supplementary_Examination_StomachMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Supplementary_Examination_Stomach");
            ...
            this.Property(t => t.pathology).HasColumnName("pathology");
