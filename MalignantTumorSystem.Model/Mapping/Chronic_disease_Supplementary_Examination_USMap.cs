...
{
    public class Chronic_disease_Supplementary_Examination_USMap :EntityTypeConfiguration<Chronic_disease_Supplementary_Examination_US>
    {
        public Chronic_disease_Supplementary_Examination_USMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Supplementary_Examination_US");
