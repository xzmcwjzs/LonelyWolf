...
{
    public class Chronic_disease_Supplementary_Examination_XMap :EntityTypeConfiguration<Chronic_disease_Supplementary_Examination_X>
    {
        public Chronic_disease_Supplementary_Examination_XMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("Chronic_disease_Supplementary_Examination_X");
