...
<assembly: WebActivatorEx.PreApplicationStartMethod(GetType(Global.MalignantTumorSystem.WebApplication.App_Start.EntityFrameworkProfilerBootstrapper), "PreStart")>
Namespace App_Start
