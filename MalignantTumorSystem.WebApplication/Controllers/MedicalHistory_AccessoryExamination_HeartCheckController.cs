...
{
    public class MedicalHistory_AccessoryExamination_HeartCheckController : BaseTopController
    {
        //
        // GET: /MedicalHistory_AccessoryExamination_HeartCheck/
        ...
        [Inject]
        public IChronic_disease_Supplementary_Examination_HeartService disease_Supplementary_Examination_HeartService { get; set; }
        #region 框架页
        ...
        //新增页
        public ActionResult HeartCheck()
        {
        ...
        public ActionResult List()
        {
            ...
            var disease_Comm_Testing_BloodList =disease_Supplementary_Examination_HeartService.LoadSearchEntities(commonParam);
            totalCount = commonParam.TotalCount;
            int PageCount = Convert.ToInt32(Math.Ceiling((double)totalCount / pageSize));

            List<Chronic_disease_Supplementary_Examination_Heart> result = new List<Chronic_disease_Supplementary_Examination_Heart>();
            result.AddRange(disease_Comm_Testing_BloodList);
            PagerInfo pager = new PagerInfo();
            pager.PageIndex = pageIndex;
            pager.PageSize = pageSize;
            pager.TotalCount = totalCount;
            PagerQuery<PagerInfo, List<Chronic_disease_Supplementary_Examination_Heart>> query = new PagerQuery<PagerInfo, List<Chronic_disease_Supplementary_Examination_Heart>>(pager, result);
        ...
        public ActionResult Show()
        {
            ...
            if (id != "")
            {
                var result = disease_Supplementary_Examination_HeartService.LoadEntityAsNoTracking(t => t.id.Contains(id));
