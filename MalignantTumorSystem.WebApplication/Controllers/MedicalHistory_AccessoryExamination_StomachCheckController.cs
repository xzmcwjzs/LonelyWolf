...
{
    public class MedicalHistory_AccessoryExamination_StomachCheckController : BaseTopController
    {
        //
        // GET: /MedicalHistory_AccessoryExamination_StomachCheck/
        ...
        [Inject]
        public IChronic_disease_Supplementary_Examination_StomachService disease_Supplementary_Examination_StomachService { get; set; }
        #region 框架页
        ...
        //新增页
        public ActionResult StomachCheck()
        {
        ...
        public ActionResult List()
        {
            ...
            var disease_Comm_Testing_BloodList = disease_Supplementary_Examination_StomachService.LoadSearchEntities(commonParam);
            totalCount = commonParam.TotalCount;
            int PageCount = Convert.ToInt32(Math.Ceiling((double)totalCount / pageSize));

            List<Chronic_disease_Supplementary_Examination_Stomach> result = new List<Chronic_disease_Supplementary_Examination_Stomach>();
            result.AddRange(disease_Comm_Testing_BloodList);
            PagerInfo pager = new PagerInfo();
            pager.PageIndex = pageIndex;
            pager.PageSize = pageSize;
            pager.TotalCount = totalCount;
            PagerQuery<PagerInfo, List<Chronic_disease_Supplementary_Examination_Stomach>> query = new PagerQuery<PagerInfo, List<Chronic_disease_Supplementary_Examination_Stomach>>(pager, result);
        ...
        public ActionResult AddAndUpdate()
        {
            ...
            Chronic_disease_Supplementary_Examination_Stomach entity = new Chronic_disease_Supplementary_Examination_Stomach();
            ...
            entity.pathology = Request["pathology"];
            ...
            if (file1 != null)
            {
                ...
                if (!string.IsNullOrEmpty(fileName1))
                {
                    ...
                    string path = "/UploadFiles/Stomach/" + DateTime.Now.ToString("yyyyMM") + "/" + DateTime.Now.ToString("dd") + "/";
            ...
            if (string.IsNullOrEmpty(id))
            {
                if (disease_Supplementary_Examination_StomachService.AddEntity(entity))
                {
                    ...
                    ehr.item_type = Model.Enum.EHRAbstractTypeEnum.Stomach.ToString();
            ...
            {
                if (disease_Supplementary_Examination_StomachService.UpdateEntity(entity))
                {
                    msg = "修改成功";
                }
            }
        ...
        public ActionResult Show()
        {
            ...
            if (id != "")
            {
                var result = disease_Supplementary_Examination_StomachService.LoadEntityAsNoTracking(t => t.id.Contains(id));
