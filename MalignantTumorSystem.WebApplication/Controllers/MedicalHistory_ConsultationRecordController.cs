...
{
    public class MedicalHistory_ConsultationRecordController : BaseTopController
    {
        //
        // GET: /MedicalHistory_ConsultationRecord/
        [Inject]
        ...
        //新增页面
        public ActionResult ConsultationRecord()
        {
        ...
        public ActionResult List()
        {
            ...
            var disease_HospitalizationList = disease_Hospitalization_ConsultationRecordService.LoadSearchEntities(hospitalizationParam);
        ...
        public ActionResult Show()
        {
            ...
            if (id != "")
            {
                var result = disease_Hospitalization_ConsultationRecordService.LoadEntityAsNoTracking(t => t.id.Contains(id));
