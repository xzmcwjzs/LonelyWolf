...
{
    public class MedicalHistory_HospitalizationExpensesController : BaseTopController
    {
        //
        // GET: /MedicalHistory_HospitalizationExpenses/
        [Inject]
        ...
        //新增页
        public ActionResult HospitalizationExpenses()
        {
        ...
        public ActionResult List()
        {
            ...
            var disease_HospitalizationList = disease_Hospitalization_ExpensesService.LoadSearchEntities(hospitalizationParam);
        ...
        public ActionResult AddAndUpdate()
        {
            ...
            Chronic_disease_Hospitalization_Expenses entity = new Chronic_disease_Hospitalization_Expenses();
            ...
            entity.total = Request["cost"];
            entity.pay_way = Request["payWay"];
            entity.self_cost = Request["payself"]; 
            ...
            if (string.IsNullOrEmpty(id))
            {
                if (disease_Hospitalization_ExpensesService.AddEntity(entity))
                {
                    msg = "保存成功";
                }
                else
            ...
            {
                if (disease_Hospitalization_ExpensesService.UpdateEntity(entity))
                {
                    msg = "保存成功";
                }
            }
