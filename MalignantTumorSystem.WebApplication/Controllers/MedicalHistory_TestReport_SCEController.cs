...
{
    public class MedicalHistory_TestReport_SCEController : BaseTopController
    {
        //
        // GET: /MedicalHistory_TestReport_SCE/
        ...
        [Inject]
        public IChronic_disease_Comm_Testing_SCEService disease_Comm_Testing_SCEService { get; set; }
        [Inject]
        public IChronic_disease_Comm_Testing_SCEAddService disease_Comm_Testing_SCEAddService { get; set; }
        ...
        public ActionResult List()
        {
            ...
            var disease_Comm_Testing_BloodList = disease_Comm_Testing_SCEService.LoadSearchEntities(commonParam);
            totalCount = commonParam.TotalCount;
            int PageCount = Convert.ToInt32(Math.Ceiling((double)totalCount / pageSize));

            List<Chronic_disease_Comm_Testing_SCE> result = new List<Chronic_disease_Comm_Testing_SCE>();
            result.AddRange(disease_Comm_Testing_BloodList);
            PagerInfo pager = new PagerInfo();
            pager.PageIndex = pageIndex;
            pager.PageSize = pageSize;
            pager.TotalCount = totalCount;
            PagerQuery<PagerInfo, List<Chronic_disease_Comm_Testing_SCE>> query = new PagerQuery<PagerInfo, List<Chronic_disease_Comm_Testing_SCE>>(pager, result);
        ...
        public ActionResult AddAndUpdate()
        {
            ...
            Chronic_disease_Comm_Testing_SCE entity = new Chronic_disease_Comm_Testing_SCE();
            ...
            if (Request["project1"].Equals("葡萄糖测定") || Request["project1"].Equals("乳酸测定") || Request["project1"].Equals("乳酸脱氢酶测定(LDH)") || Request["project1"].Equals("腺苷脱氢酶(ADA)") || Request["project1"].Equals("淀粉酶(AMY)") || Request["project1"].Equals("中性粒细胞") || Request["project1"].Equals("嗜酸性粒细胞") || Request["project1"].Equals("淋巴细胞"))
            {
            ...
            if (Request["project2"].Equals("葡萄糖测定") || Request["project2"].Equals("乳酸测定") || Request["project2"].Equals("乳酸脱氢酶测定(LDH)") || Request["project2"].Equals("腺苷脱氢酶(ADA)") || Request["project2"].Equals("淀粉酶(AMY)") || Request["project2"].Equals("中性粒细胞") || Request["project2"].Equals("嗜酸性粒细胞") || Request["project2"].Equals("淋巴细胞"))
            {
            ...
            if (Request["project3"].Equals("葡萄糖测定") || Request["project3"].Equals("乳酸测定") || Request["project3"].Equals("乳酸脱氢酶测定(LDH)") || Request["project3"].Equals("腺苷脱氢酶(ADA)") || Request["project3"].Equals("淀粉酶(AMY)") || Request["project3"].Equals("中性粒细胞") || Request["project3"].Equals("嗜酸性粒细胞") || Request["project3"].Equals("淋巴细胞"))
            {
            ...
            if (Request["project4"].Equals("葡萄糖测定") || Request["project4"].Equals("乳酸测定") || Request["project4"].Equals("乳酸脱氢酶测定(LDH)") || Request["project4"].Equals("腺苷脱氢酶(ADA)") || Request["project4"].Equals("淀粉酶(AMY)") || Request["project4"].Equals("中性粒细胞") || Request["project4"].Equals("嗜酸性粒细胞") || Request["project4"].Equals("淋巴细胞"))
            {
            ...
            if (Request["project5"].Equals("葡萄糖测定") || Request["project5"].Equals("乳酸测定") || Request["project5"].Equals("乳酸脱氢酶测定(LDH)") || Request["project5"].Equals("腺苷脱氢酶(ADA)") || Request["project5"].Equals("淀粉酶(AMY)") || Request["project5"].Equals("中性粒细胞") || Request["project5"].Equals("嗜酸性粒细胞") || Request["project5"].Equals("淋巴细胞"))
            {
            ...
            System.Collections.Generic.List<Chronic_disease_Comm_Testing_SCEAdd> subjectiveList = new System.Collections.Generic.List<Chronic_disease_Comm_Testing_SCEAdd>();

            for (int i = 1; i < 19; i++)
            {
                if (!string.IsNullOrEmpty(Request["project_" + i]))
                { 
                    Chronic_disease_Comm_Testing_SCEAdd entity1 = new Chronic_disease_Comm_Testing_SCEAdd();
                    entity1.id = Guid.NewGuid().ToString();
                    entity1.add_id = entity.id;
                    entity1.name = Request["project_" + i];
                    if (entity1.name != null)
                    {
                        if (Request["project_" + i].Equals("葡萄糖测定") || Request["project_" + i].Equals("乳酸测定") || Request["project_" + i].Equals("乳酸脱氢酶测定(LDH)") || Request["project_" + i].Equals("腺苷脱氢酶(ADA)") || Request["project_" + i].Equals("淀粉酶(AMY)") || Request["project_" + i].Equals("中性粒细胞") || Request["project_" + i].Equals("嗜酸性粒细胞") || Request["project_" + i].Equals("淋巴细胞"))
                        {
            ...
            if (string.IsNullOrEmpty(id))
            {
                if (disease_Comm_Testing_SCEService.AddEntity(entity) && disease_Comm_Testing_SCEAddService.UpdateSubjective(subjectiveList, entity.id))
                {
            ...
            {
                if (disease_Comm_Testing_SCEService.UpdateEntity(entity) && disease_Comm_Testing_SCEAddService.UpdateSubjective(subjectiveList, entity.id))
                {
                    msg = "修改成功";
                }
            }
        ...
        public ActionResult Show()
        {
            ...
            if (id != "")
            {
                var result = disease_Comm_Testing_SCEService.LoadEntityAsNoTracking(t => t.id.Contains(id));
        ...
        public ActionResult ShowAdd()
        {
            ...
            if (id != "")
            {
                var result = disease_Comm_Testing_SCEAddService.LoadEntityAsNoTracking(t => t.add_id.Contains(id));
                return Json(result, JsonRequestBehavior.AllowGet);
            }
            else
            {
