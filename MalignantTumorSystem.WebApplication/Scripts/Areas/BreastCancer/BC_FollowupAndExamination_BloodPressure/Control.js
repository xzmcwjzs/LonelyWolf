$(function () { 
    ...
    function log(event, data, formatted) {
        ...
        var ss2 = new Array();
        var ss3 = new Array();
        $.post("/BreastCancer/BC_FollowupAndExamination_BloodPressure/ShowText2?id_card_number=" + $("#id_card_number").val(),
       function (datas) {
           if (datas != ""&&datas!=null) {
...
function save() {
    if ($("#name").val() == "") {
        ...
        $.post("/BreastCancer/BC_FollowupAndExamination_BloodPressure/AddAndUpdate?id=" + id + "&community_code=" + community_code + "&worker=" + worker,
                $("#form1").serialize(),
                function (msgs) {
                    var msg = msgs.split(',');
                    alert(msg[0]);
