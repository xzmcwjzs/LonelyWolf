$(function () {
    $.post("/MedicalHistory_AccessoryExamination_XCheck/Show?id=" + id,
          function (data) {
              dts = eval(data);
              if (dts != "" && dts != null) {
                  ...
                  if (dts[0].community_code != "") {
                      ...
                      //-----市-----
                      $.post("/Data/City4?code=" + code1.substring(0, 2),
                       function (data) {
                           dat1 = eval(data);
                           $("#ddlCity").empty();
                      ...
                      //-----区/县-----
                      $.post("/Data/County4?code=" + code1.substring(0, 4),
                       function (data) {
                           dat1 = eval(data);
                           $("#ddlCounty").empty();
                      ...
                      //-------镇/村-------
                      $.post("/Data/Street4?code=" + code1.substring(0, 6),
                       function (data) {
                           dat1 = eval(data);
                           $("#ddlStreet").empty();
                      ...
                      $.post("/Data/Community4?code=" + code1.substring(0, 9),
                       function (data) {
                           dat1 = eval(data);
                           $("#ddlCommunity").empty();
