...
$(function () { 
    ...
    $.post("/Data/DataNames?type=" + types,
        function (data1) {
            ...
            $("#project7").empty();
            $("#project7").append("<option value=" + "" + ">==请选择==</option>");
            $("#project8").empty();
            $("#project8").append("<option value=" + "" + ">==请选择==</option>");
            $("#project9").empty();
            $("#project9").append("<option value=" + "" + ">==请选择==</option>");
            if (dat1 != null) {
                for (var i = 0; i < dat1.length; i++) {
                    ...
                    $("#project7").append("<option value=" + dat1[i].name + ">" + dat1[i].name + "</option>");
                    $("#project8").append("<option value=" + dat1[i].name + ">" + dat1[i].name + "</option>");
                    $("#project9").append("<option value=" + dat1[i].name + ">" + dat1[i].name + "</option>");
                }
            }
        });
    //=====1======
        ...
        $.post("/Data/DataResults?type=" + types,
             { Name: $('#project7').val() },
                 function (data) {
                     ...
                     if (dat1 != null) {
                         for (var i = 0; i < dat1.length; i++) {
                             $("#Select7").append("<option value=" + dat1[i].result_name + ">" + dat1[i].result_name + "</option>");
                         }
                     }
                 });
    })
        ...
        $.post("/Data/DataResults?type=" + types,
             { Name: $('#project8').val() },
                 function (data) {
                     dat1 = eval(data);
                     $("#Select8").empty();
                     $("#Select8").append("<option value=" + "" + ">==请选择==</option>");
                     if (dat1 != null) {
                         for (var i = 0; i < dat1.length; i++) {
                             $("#Select8").append("<option value=" + dat1[i].result_name + ">" + dat1[i].result_name + "</option>");
                         }
                     }
                 });
    })
        ...
        $.post("/Data/DataResults?type=" + types,
             { Name: $('#project9').val() },
                 function (data) {
                     dat1 = eval(data);
                     $("#Select9").empty();
                     $("#Select9").append("<option value=" + "" + ">==请选择==</option>");
                     if (dat1 != null) {
                         for (var i = 0; i < dat1.length; i++) {
                             $("#Select9").append("<option value=" + dat1[i].result_name + ">" + dat1[i].result_name + "</option>");
                         }
                     }
                 });
    })
                       ...
                       $.post("/Data/DataResults?type=" + types,
                        { Name: dts[0].name7 },
                         function (data) {
                             ...
                             $("#Select7").val(dts[0].result7);
                         });
                       $("#Text25").val(dts[0].unit7);
                       $("#Text26").val(dts[0].qujian7);
                       $("#Text27").val(dts[0].tishi7);
                       $("#Text28").val(dts[0].beizhu7);

                       $("#project8").val(dts[0].name8);
                       $.post("/Data/DataResults?type=" + types,
                        { Name: dts[0].name8 },
                         function (data) {
                             dat1 = eval(data);
                             ...
                             $("#Select8").val(dts[0].result8);
                         });
                       $("#Text29").val(dts[0].unit8);
                       $("#Text30").val(dts[0].qujian8);
                       $("#Text31").val(dts[0].tishi8);
                       $("#Text32").val(dts[0].beizhu8);

                       $("#project9").val(dts[0].name9);
                       $.post("/Data/DataResults?type=" + types,
                        { Name: dts[0].name9 },
                         function (data) {
                             dat1 = eval(data);
                             ...
                             $("#Select9").val(dts[0].result9);
                         });
                       $("#Text33").val(dts[0].unit9);
                       $("#Text34").val(dts[0].qujian9);
                       $("#Text35").val(dts[0].tishi9);
                       $("#Text36").val(dts[0].beizhu9);
                   }
               })
...
function sure() {
    if ($("#name").val() == "") {
        ...
        $.post("/MedicalHistory_TestReport_Faeces/AddAndUpdate?id=" + id + "&community_code=" + community_code + "&worker=" + worker,
            $("#form1").serialize(),
            function (msgs) {
                var msg = msgs.split(',');
                alert(msg[0]);
