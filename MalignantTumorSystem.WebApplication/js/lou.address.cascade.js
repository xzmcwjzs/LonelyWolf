$(function () {
    ...
    $("#ddlProvince1").change(function () {
        $.post("../../Data/City.ashx?code=" + $("#ddlProvince1").val(),
        function (data) {
            dat = eval(data);
            $("#ddlCity1").empty();
    ...
    $("#ddlCity1").change(function () {
        $.post("../../Data/County.ashx?code=" + $("#ddlCity1").val(),
        function (data) {
            dat = eval(data);
            $("#ddlCounty1").empty();
            $("#ddlCounty1").append("<option value=" + "" + ">=请选择=</option>");
    ...
    $("#ddlProvince2").change(function () {
        $.post("../../Data/City.ashx?code=" + $("#ddlProvince2").val(),
        function (data) {
            dat = eval(data);
            $("#ddlCity2").empty();
    ...
    $("#ddlCity2").change(function () {
        $.post("../../Data/County.ashx?code=" + $("#ddlCity2").val(),
        function (data) {
            dat = eval(data);
            $("#ddlCounty2").empty();
            $("#ddlCounty2").append("<option value=" + "" + ">=请选择=</option>");
    ...
    $("#ddlCounty2").change(function () {
        $.post("../../Data/Street.ashx?code=" + $("#ddlCounty2").val(),
        function (data) {
            dat = eval(data);
            $("#ddlStreet2").empty();
            $("#ddlStreet2").append("<option value=" + "" + ">=请选择=</option>");
    ...
    $("#ddlStreet2").change(function () {
        $.post("../../Data/Community.ashx?code=" + $("#ddlStreet2").val(),
        function (data) {
            dat = eval(data);
            $("#ddlCommunity2").empty();
            $("#ddlCommunity2").append("<option value=" + "" + ">=请选择=</option>");
