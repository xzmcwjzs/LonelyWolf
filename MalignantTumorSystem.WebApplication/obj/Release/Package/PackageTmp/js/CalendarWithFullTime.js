    ...
    try{
        if (WebCalendar.objExport.value.trim() != ""){
            ...
            else
            {
                ...
                parseInt(WebCalendar.thisYear, 10)+" "+ parseInt(WebCalendar.thisHour, 10) +":"+ parseInt(WebCalendar.thisMinute, 10); writeCalendar()
                +":"+ parseInt(WebCalendar.thisSecond, 10); writeCalendar();
            }
        }  else writeCalendar();
